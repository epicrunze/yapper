...
ROOT = "/hpc/home/bfa6/work/github/yapper"
...
# load dataset
with open(ROOT + "/" + "dataset/chunks.json", "r") as f:
    dataset =  json.load(f)
...
def calculate_rewards(prompts, completions, alpha: float = 0.90, **kwargs):
    ...
    for response in responses:
        ...
        r_final = alpha * r_bert + (1 - alpha) * r_len + 1.0 * r_multi # originally 0.2 for test 4. Test 5 0.5, Test6 1
...
training_args = GRPOConfig(
    ...
    output_dir = ROOT + "/" + "results/experiment_0/test6/output",
...
# In[ ]:
model.save_lora(ROOT + "/" + "results/experiment_0/test6/save") 
