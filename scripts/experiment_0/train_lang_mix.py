...
ROOT = "/data/epicrunze/Projects/yapper"
...
def calculate_rewards(prompts, completions, alpha: float = 0.90, **kwargs):
    ...
    for response in responses:
        ...
        r_final = alpha * r_bert + (1-alpha) * r_len
...
training_args = GRPOConfig(
    ...
    output_dir = ROOT + "/" + "results/experiment_0/test0/output",
...
# In[ ]:
model.save_lora(ROOT + "/" + "results/experiment_0/test0/save") 
